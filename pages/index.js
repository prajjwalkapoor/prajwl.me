  ...
  return (
    <>
      ...
      <div className="my-6 flex flex-col items-center gap-x-12 xl:mb-12 xl:flex-row">
        <div className="pt-6">
          <h1 className="my-2 pb-6 text-3xl font-extrabold leading-9 tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl sm:leading-10 md:text-6xl md:leading-14">
            Hi, I’m Prajjwal Kapoor
          </h1>
          <h2 className="prose my-2 text-lg text-gray-600 dark:text-gray-400">
            I’m a Full Stack Developer from India 🇮🇳. I’m passionate about building products that
            help people and make their lives easier.
          </h2>
